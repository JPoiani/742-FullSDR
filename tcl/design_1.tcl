...
proc create_root_design { parentCell } {
  ...
  set full_radio_0 [ create_bd_cell -type ip -vlnv jhu.edu:poiani:full_radio:1.0 full_radio_0 ]
...
\
  ...
  set_property -dict [list \
    ...
    CONFIG.C_RX_FIFO_PF_THRESHOLD {512} \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M01_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins system_ila_0/SLOT_2_AXI]
  ...
  connect_bd_net -net s00_axi_aclk_0_1 [get_bd_ports clk125] [get_bd_pins lowlevel_dac_intfc_0/clk125] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins system_ila_0/clk] [get_bd_pins xpm_cdc_gen_0/dest_clk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins axi_fifo_mm_s_0/s_axi_aclk] [get_bd_pins full_radio_0/s00_axi_aclk]
  connect_bd_net -net xpm_cdc_gen_0_dest_rst_out [get_bd_pins xpm_cdc_gen_0/dest_rst_out] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins system_ila_0/resetn] [get_bd_pins lowlevel_dac_intfc_0/resetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axi_fifo_mm_s_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins full_radio_0/s00_axi_aresetn]
